...
@Data
public class HrEntryApplyVO implements Serializable {
    @Serial
    ...
    @Schema(description = "工资卡号（脱敏）")
    private String bankAccount;

    @Schema(description = "是否自动创建系统账号")
    private Integer autoCreateUser;

    @Schema(description = "流程实例ID")
    private Long flowInstanceId;

    @Schema(description = "状态 0草稿 1审批中 2已通过 3已驳回 4已撤回")
