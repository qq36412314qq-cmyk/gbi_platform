...
@Data public class HrSalaryMonthVO implements Serializable {
    ...
    @Schema(description="考勤扣款") private BigDecimal attendanceDeduction;
    @Schema(description="旷工扣款") private BigDecimal absentDeduction;
    @Schema(description="迟到扣款") private BigDecimal lateDeduction;
