...
/**
 * 租赁合同接口（租户+摊位租赁，生效联动摊位状态与押金流水，前端 api/lease.ts contract 部分）
 *
 * @author gbi
 */
@Tag(name = "物业管理-租赁合同")
...
public class LeaseContractController {
    ...
    @Operation(summary = "合同分页（含租户/摊位/分类名称）")
    ...
    @Operation(summary = "新增合同（摊位置为已租，押金写收入流水）")
    ...
    @Operation(summary = "退租（高危操作：摊位置空、押金退费支出流水、强制审计）")
