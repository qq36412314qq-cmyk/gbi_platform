...
/**
 * 收费规则-摊位绑定关联实体：biz_fee_rule_stall_rel
 * 摊位多选收费规则（同收费类型限选一条，service 层校验）；
 * override_* 字段为单摊位特殊规则覆盖预留（本期界面不提供）
 *
 * @author gbi
 */
@Data
@EqualsAndHashCode(callSuper = true)
@TableName("biz_fee_rule_stall_rel")
